...
<div class="container">
	 	...
	 	<div class="panel panel-success">
	        <div class="panel-heading"><h1 class="panel-title">系统信息</h1></div>	        
	        <table class="table table-striped table-bordered table-hover" >
			    <tr><th width="15%" bgcolor="#ccc" >操作系统</th> <td><?php echo PHP_OS;?></td></tr>
			    <tr><th bgcolor="#ccc">PHP版本</th><td><?php echo PHP_VERSION;?></td></tr>
			    <tr><th bgcolor="#ccc">运行方式</th><td><?php echo PHP_SAPI;?></td></tr>
			    <tr><th bgcolor="#ccc">数据库服务器</th><td><?php echo (C("DB_HOST")); ?></td></tr>
			    <tr><th bgcolor="#ccc">数据库名字</th><td><?php echo (C("DB_NAME")); ?></td></tr>
			    <tr><th bgcolor="#ccc">数据库端口</th><td><?php echo (C("DB_PORT")); ?></td></tr>			    
			    <tr><th bgcolor="#ccc">开发团队</th><td>yaolh</td></tr>
			    <tr><th bgcolor="#ccc">客户端IP</th><td><?php echo ($_SESSION['ip']); ?></td></tr>
			    <tr><th bgcolor="#ccc">客户端浏览器</th><td><?php echo ($_SESSION['browser']); ?></td></tr>
			    <tr><th bgcolor="#ccc">客户端系统</th><td><?php echo ($_SESSION['os']); ?></td></tr>
		    </table>	             			                	
	    </div>
</div>
